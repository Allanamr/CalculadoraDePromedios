/* In this exercise, you'll use the assignment scores for each student to calculate their 
...
decimal sophiaScore = (decimal) sophiaSum / currentAsigments;
decimal nicolasScore = (decimal) nicolasSum / currentAsigments;
